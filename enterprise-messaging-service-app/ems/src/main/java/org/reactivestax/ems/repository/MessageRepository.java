...
public interface MessageRepository extends JpaRepository<Message, Long>, JpaSpecificationExecutor<Message> {
    ...
    Page<Message> findByCustomer_CustomerIdAndMessageTypeAndCreationTimeAfter(String customerId, MessageType messageType, LocalDateTime creationTimeAfter, Pageable pageable);
}
