...
function SignUp() {
    ...
    const handleSignUp = async (e) => {
        ...
        if (form.checkValidity() === false) {
            ...
            await fetch("http://localhost:30002/CanadaActiveLife/v1/signup", {
                method: 'POST',
                headers: {
        ...
        <Modal show={true} centered>
            ...
            >
                <Modal.Body>
                    ...
                    <FloatingLabel className="mb-1" controlId="lang" label="Preferred Language">
                        <Form.Control
                            type="text"
                    ...
                    <FloatingLabel className="mb-1" controlId="familyPin" label="Famiy PIN">
                        <Form.Control
                            type="text"
